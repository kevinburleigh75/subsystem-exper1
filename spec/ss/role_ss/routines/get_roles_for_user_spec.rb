...
describe RoleSs::GetRolesForUser do
  context "there are no roles for the given user" do
    it "returns no roles" do
      ...
      RoleSs::UserRoleMap.create!(user: other_user, role: other_role)
  ...
  context "there is one role for the given user" do
    it "returns the user's role" do
      ...
      RoleSs::UserRoleMap.create!(user: target_user, role: target_role)
  ...
  context "there are multiple roles for the given user" do
    it "returns all the user's roles" do
      ...
      RoleSs::UserRoleMap.create!(user: target_user, role: target_role1)
      ...
      RoleSs::UserRoleMap.create!(user: target_user, role: target_role2)
